...
* **Audio & Voice Processing**:
  ...
  * Dedicated sound and audio pipeline tests in [tests/test_sounds.py](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/tests/test_sounds.py).
* **Serverless Signaling Backend**:
  * Cloudflare Worker implementation using Durable Objects in [cloudflare/src/index.js](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/cloudflare/src/index.js) supporting room isolation, heartbeat pings, and session tokens.
...
* **NAT Traversal & Network Discovery**:
  * Cross-platform network and NAT discovery module in [nat_discovery.py](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/nat_discovery.py).
  * Multi-candidate gateway probing (`.1`, `.254`, `.2`) and VPN gateway fallback support.
  * Consecutive failure threshold logic in [natpmp.py](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/natpmp.py) (deactivates automatically after 3 failed attempts to avoid log and resource bloat).
* **Reliability & Recovery**:
  * Asynchronous message outbox queue in [outbox.py](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/outbox.py) to buffer signals during transient network disconnects.
  * In-app "Restart Application" button and unhandled exception auto-recovery mechanism.
* **Code Quality & Tooling**:
  * Centralized design system tokens in [theme/flet_theme.py](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/theme/flet_theme.py).
  * Modular constants system in [constants/](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/constants/) (`client_constants.py`, `crypto_constants.py`, `invite_constants.py`, `natpmp_constants.py`, `secure_store_constants.py`, `server_constants.py`).
  * SonarQube static analysis configuration ([sonar-project.properties](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/sonar-project.properties)) and Ruff rules ([ruff.toml](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/ruff.toml)).
...
* **Cryptography & Storage**:
  ...
  * Hardened file size checks and build-time asset verification in [build.py](file:///c:/Users/naman/OneDrive/Desktop/Project/helucryptic/build.py).
